...
test('sign empty string', () => {
  ...
  expect(Ads.sign(secretKey, data)).toBe(expSignature)
})

test('sign data', () => {
  expect(Ads.sign('CA978112CA1BBDCAFAC231B39A23DC4DA786EFF8147C4E72B9807785AFEE48BB', '74657374')).toBe(
...
test('sign text', () => {
  expect(Ads.signText('CA978112CA1BBDCAFAC231B39A23DC4DA786EFF8147C4E72B9807785AFEE48BB', 'test')).toBe(
    'fbf7ff4db3f5e300119904f07ed926f6b65d087d0019099ad3d83cf12bf310f26dbb6116a1a00af0012485c0ff7baaa504d46d3836e61668affed516b1420c01')
})
...
test('get public key', () => {
  expect(Ads.getPublicKey('CA978112CA1BBDCAFAC231B39A23DC4DA786EFF8147C4E72B9807785AFEE48BB')).toBe('eae1c8793b5597c4b3f490e76ac31172c439690f8ee14142bb851a61f9a49f0e')
  expect(Ads.getPublicKey('2c26b46b68ffc68ff99b453c1d30413413422d706483bfa0f98a5e886266e7ae')).toBe('34d26579dbb456693e540672cf922f52dde0d6532e35bf06be013a7c532f20e0')
})
